...
final class QueryUtility  {
    ...
    /**
     * Query the Guardian News Data set and return a list of {@link GuardianNews} objects.
     */
    static List<GuardianNews> fetchGuardianNews(String requestUrl) {
        // Create URL object
    ...
    /**
     * Return a list of {@link GuardianNews} objects that has been built up from
    ...
    private static List<GuardianNews> extractFeatureFromJson(String guardianNewsJSON) {
        ...
        // Create an empty ArrayList that we can start adding guardian news to
        List<GuardianNews> guardianNewsArrayList = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                JSONObject currentGuardianNews = resultsArray.getJSONObject(i);
